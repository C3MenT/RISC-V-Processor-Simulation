...
objects = $(obj_dir)/main.o $(obj_dir)/datapath.o $(obj_dir)/fetch.o $(obj_dir)/decoder.o \
	$(obj_dir)/execute.o $(obj_dir)/mem.o $(obj_dir)/writeback.o
headers = $(header_dir)/datapath.h $(header_dir)/fetch.h $(header_dir)/decoder.h \
	$(header_dir)/execute.h $(header_dir)/mem.h $(header_dir)/writeback.h
...
$(obj_dir)/execute.o : $(src_dir)/execute.cpp $(header_dir)/execute.h $(header_dir)/datapath.h
	g++ -g -c $(src_dir)/execute.cpp -o $(obj_dir)/execute.o
...
$(obj_dir)/mem.o : $(src_dir)/mem.cpp $(header_dir)/mem.h $(header_dir)/datapath.h
	g++ -g -c $(src_dir)/mem.cpp -o $(obj_dir)/mem.o

$(obj_dir)/writeback.o : $(src_dir)/writeback.cpp $(header_dir)/writeback.h $(header_dir)/datapath.h
	g++ -g -c $(src_dir)/writeback.cpp -o $(obj_dir)/writeback.o
